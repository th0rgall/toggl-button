...
function getDates(titleElement) {
  ...
  let bottomHalf = dependOn(topHalf, topHalf.nextSibling.nextSibling);

  // navigate down
  let timeInfo = dependOn(bottomHalf, bottomHalf.firstChild);
  var timeContainerWrap = null;
  if (timeInfo && timeInfo.children) timeContainerWrap = timeInfo.children;
